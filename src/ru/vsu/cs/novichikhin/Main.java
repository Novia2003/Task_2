...
public class Main {
    ...
    static void compareValue(int a, int b) {
        if (a == b) {
            System.out.print("Обе команды заработали по 1 очку");
        } else {
            if (a > b) {
                System.out.print("Первая команда заработала 3 очка, а вторая команда заработала 0 очков");
            } else {
                System.out.print("Первая команда заработала 0 очков, а вторая команда заработала 3 очка");
            }
        }
    }
}